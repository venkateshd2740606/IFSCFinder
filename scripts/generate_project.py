#!/usr/bin/env python3
"""Generate IFSCFinder Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\IFSCFinder")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "ifscfinder"
TEST = APP / "src" / "test" / "java" / "com" / "ifscfinder"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "ifscfinder"
...
android {
    namespace = "com.ifscfinder"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.ifscfinder.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.ifscfinder.data.** { *; }
-keep class com.ifscfinder.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "ifscfinder-game",
    "storage_bucket": "ifscfinder-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.ifscfinder.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating IFSCFinder project files...")
