...
1. Open `D:\Work\Games\IFSCFinder` in Android Studio.
...
The project is scaffolded from PuzzleVerse. Replace `engine/ScrewPuzzleEngine.kt` with `IFSCFinderEngine.kt` (tube pour logic) and update the game board UI component.
