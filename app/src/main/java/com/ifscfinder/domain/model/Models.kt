package com.ifscfinder.domain.model
...
/** Sort palette index 0..N-1 mapped to UI colors in [IFSCFinderPalette]. */
data class IFSCFinderLevel(
    val id: Long = 0,
    val seed: Long,
    val levelNumber: Int,
    val difficulty: Difficulty,
    val initialTubes: List<List<Int>>,
    val tubeCapacity: Int = IFSCFinderLevel.DEFAULT_CAPACITY,
    val colorCount: Int,
