package com.ifscfinder.data.mapper
...
object DataMappers {
    ...
    fun toEntity(game: IFSCFinderGame): GameEntity = GameEntity(
        id = game.id,
    ...
    fun fromEntity(entity: GameEntity): IFSCFinderGame {
